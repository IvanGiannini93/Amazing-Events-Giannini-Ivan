...
async function getDataUpcomming() {
    let eventsData;
    eventsData = await getData();
    cardsData = eventsData.events;
    let actualDate = new Date(eventsData.currentDate);
    showCards(cardsData, idContainer, actualDate);
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', () => {
            ...
            showCards(cardsToShow, idContainer, actualDate);
        })
    })
...
function showCards(array, idContainer, actualDate) {
